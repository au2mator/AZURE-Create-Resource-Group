...
#
#
# Init Release: 29.04.2022
# Last Update: 29.04.2022
# Code Template V 1.4
#
# URL: 
# Github: https://github.com/au2mator/AZURE-Create-Resource-Group
#################
...
[string]$LogfileName = "AZURE - Create Azure Resource Group"
...
try {
    ...
    try {
        Write-au2matorLog -Type INFO -Text "Try to create Azure Resource Group"
        $Location = GET-Location -Name $c_Location -Searchcoloumn LocationDisplay -resultcoloumn LocationName

        $URL = "https://management.azure.com/subscriptions/$c_Subscription/resourceGroups/$($c_ResourceGroupName)?api-version=$apiversion"
...
"@   
        ...
        Write-au2matorLog -Type INFO -Text "Resource Group was created: $c_ResourceGroupName"



        $au2matorReturn = "Resource Group was created: $c_ResourceGroupName"
        $TeamsReturn = "Resource Group was created: $c_ResourceGroupName" #No Special Characters allowed
        $AdditionalHTML = "Resource Group was created: $c_ResourceGroupName
            <br>
                "
        $Status = "COMPLETED"
    }
